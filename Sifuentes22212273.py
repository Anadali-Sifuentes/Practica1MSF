...
plt.show()
fig1.savefig('step_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
           fontsize = 9, frameon = True)
plt.show()
fig2.savefig('impulse_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
           fontsize = 9, frameon = True)
plt.show()
fig3.savefig('ramp_python.pdf',bbox_inches = 'tight')
...
plt.legend(bbox_to_anchor = (0.5,-0.2),loc = 'center', ncol = 3,
           fontsize = 9, frameon = True)
plt.show()
fig4.savefig('sin_python.pdf',bbox_inches = 'tight')
